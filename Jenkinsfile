...
1.  Is **poore code** ko apni **`Jenkinsfile`** file mein **replace** karein।
2.  **Git Commands** chalaayein:
    ```bash
    git add Jenkinsfile
    git commit -m "fix: Final Groovy syntax fix and adopted internal service DNS for Sonar/Nexus"
    git push